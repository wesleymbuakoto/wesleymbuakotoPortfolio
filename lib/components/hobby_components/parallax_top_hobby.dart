...
class parallax_top_hobby extends StatelessWidget {
  parallax_top_hobby({Key? key, required this.title_general,}) : super(key: key);
      ...
      child: Stack(
        children: [
          Flow(
            ...
            children: [
              Image.network(
                'https://storage.googleapis.com/wesley_web_assets/assets/hobbies/hobbypage.jpg',
